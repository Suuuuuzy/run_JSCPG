...
def run_tests(package_list, vul_type="os_command"):
    ...
    for sub_package_list in package_list:
        res_list[sub_package_list] = {}
        timeout_cnt[sub_package_list] = 0
        ...
        for package in package_list[sub_package_list]:
            try:
                ...
                res_list[sub_package_list][package] = -1
                timeout_cnt[sub_package_list] += 1
                continue
            ...
            if 1 in res:
                ...
                res_list[sub_package_list][package] = 0
            print(res)
