...
browser = chrome;
/////////
// original file:/Users/jianjia/Documents/tmp/EOPG/run_JSCPG_merge/crx_lists/jianjia_timeout/extensions/gipamokahomnoiindojdfmdeokpcakho/background-script.js
...
function getSourceID(sender, callback) {
  ...
  if (message.type === 'getSourceId') {
    ...
    /*else if(message.type === 'getScreen'){
     ...
     else if (message.type === 'cancelGetScreen') {
