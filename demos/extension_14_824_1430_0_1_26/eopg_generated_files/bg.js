// original file:../demos/extension_14_824_1430_0_1_26/src/js/Grammarly-bg.js
...
!function(modules) {
    ...
    }, __webpack_require__.p = "", __webpack_require__(__webpack_require__.s = 1083);
    ...
    function bgFetch(opts) {
        var url = opts.url;
        return delete opts.url, url ? Promise.race([ window.fetch(url, opts).then(function(resp) {
    ...
    function paramStr(data) {
        var req = "";
        for (var item in data) !function(item) {
    ...
    var isObject = __webpack_require__(8), util_1 = __webpack_require__(2), config_1 = __webpack_require__(10), message = __webpack_require__(16), log = __webpack_require__(1).Logger.create("lib.request"), AJAX_TIMEOUT = 1e4;
    util_1.isBg() && message.on("fetch", function(data, cb) {
        ...
        return void 0 === opts && (opts = {}), opts.url = url, transformOptions(opts), util_1.isBg() || config_1.isTestsMode() ? bgFetch(opts) : message.promiseBackground("fetch", opts).then(function(data) {
            if (isObject(data) && data.error) throw new Error(data.error);
            return data;
        });
    ...
    var arrayPush = __webpack_require__(101), isFlattenable = __webpack_require__(374);
    ...
    var message = __webpack_require__(16), util_1 = __webpack_require__(2), tracking_1 = __webpack_require__(9), logger_1 = __webpack_require__(1), promise_1 = __webpack_require__(63), bgonly_1 = __webpack_require__(431), on_1 = __webpack_require__(1096), appLogger = logger_1.Logger.create("lib.tracking");
    exports.gnarSpecInternal = promise_1.SafePromise.createCompletionSource(), exports.gnar = new Proxy({}, {
        ...
        bgonly_1.init(gnarSpecClass).then(function(spec) {
            ...
            var props = _a.props, method = _a.method;
    ...
    var arrayPush = __webpack_require__(101), getPrototype = __webpack_require__(59), getSymbols = __webpack_require__(102), stubArray = __webpack_require__(161), getSymbolsIn = Object.getOwnPropertySymbols ? function(object) {
    ...
    var Stack = __webpack_require__(58), arrayEach = __webpack_require__(88), assignValue = __webpack_require__(170), baseAssign = __webpack_require__(376), baseAssignIn = __webpack_require__(377), cloneBuffer = __webpack_require__(165), copyArray = __webpack_require__(167), copySymbols = __webpack_require__(378), copySymbolsIn = __webpack_require__(379), getAllKeys = __webpack_require__(159), getAllKeysIn = __webpack_require__(341), getTag = __webpack_require__(103), initCloneArray = __webpack_require__(380), initCloneByTag = __webpack_require__(381), initCloneObject = __webpack_require__(168), isArray = __webpack_require__(7), isBuffer = __webpack_require__(33), isObject = __webpack_require__(8), keys = __webpack_require__(31), CLONE_DEEP_FLAG = 1, CLONE_FLAT_FLAG = 2, CLONE_SYMBOLS_FLAG = 4, argsTag = "[object Arguments]", funcTag = "[object Function]", genTag = "[object GeneratorFunction]", objectTag = "[object Object]", cloneableTags = {};
    ...
    var baseGetAllKeys = __webpack_require__(160), getSymbolsIn = __webpack_require__(314), keysIn = __webpack_require__(44);
    module.exports = function(object) {
    ...
    var Symbol = __webpack_require__(32), isArguments = __webpack_require__(46), isArray = __webpack_require__(7), spreadableSymbol = Symbol ? Symbol.isConcatSpreadable : void 0;
    module.exports = function(value) {
        return isArray(value) || isArguments(value) || !!(spreadableSymbol && value && value[spreadableSymbol]);
    };
}, , function(module, exports, __webpack_require__) {
    var copyObject = __webpack_require__(35), keys = __webpack_require__(31);
    ...
    var copyObject = __webpack_require__(35), getSymbols = __webpack_require__(102);
    module.exports = function(source, object) {
        return copyObject(source, getSymbols(source), object);
    };
}, function(module, exports, __webpack_require__) {
    var copyObject = __webpack_require__(35), getSymbolsIn = __webpack_require__(314);
    module.exports = function(source, object) {
    ...
    var cloneArrayBuffer = __webpack_require__(106), cloneDataView = __webpack_require__(382), cloneMap = __webpack_require__(383), cloneRegExp = __webpack_require__(385), cloneSet = __webpack_require__(386), cloneSymbol = __webpack_require__(388), cloneTypedArray = __webpack_require__(166), boolTag = "[object Boolean]", dateTag = "[object Date]", mapTag = "[object Map]", numberTag = "[object Number]", regexpTag = "[object RegExp]", setTag = "[object Set]", stringTag = "[object String]", symbolTag = "[object Symbol]", arrayBufferTag = "[object ArrayBuffer]", dataViewTag = "[object DataView]", float32Tag = "[object Float32Array]", float64Tag = "[object Float64Array]", int8Tag = "[object Int8Array]", int16Tag = "[object Int16Array]", int32Tag = "[object Int32Array]", uint8Tag = "[object Uint8Array]", uint8ClampedTag = "[object Uint8ClampedArray]", uint16Tag = "[object Uint16Array]", uint32Tag = "[object Uint32Array]";
    module.exports = function(object, tag, cloneFunc, isDeep) {
    ...
    var addMapEntry = __webpack_require__(384), arrayReduce = __webpack_require__(315), mapToArray = __webpack_require__(158), CLONE_DEEP_FLAG = 1;
    module.exports = function(map, isDeep, cloneFunc) {
        var array = isDeep ? cloneFunc(mapToArray(map), CLONE_DEEP_FLAG) : mapToArray(map);
        return arrayReduce(array, addMapEntry, new map.constructor());
    };
}, function(module, exports) {
    module.exports = function(map, pair) {
    ...
    var addSetEntry = __webpack_require__(387), arrayReduce = __webpack_require__(315), setToArray = __webpack_require__(100), CLONE_DEEP_FLAG = 1;
    module.exports = function(set, isDeep, cloneFunc) {
        var array = isDeep ? cloneFunc(setToArray(set), CLONE_DEEP_FLAG) : setToArray(set);
        return arrayReduce(array, addSetEntry, new set.constructor());
    };
}, function(module, exports) {
    module.exports = function(set, value) {
    ...
    function parse(str) {
        ...
        try {
            for (var _step, _iterator = pairs[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = !0) {
                ...
                obj[decode((pair = pair.split("="))[0])] = decode(pair[1]);
            }
        } catch (err) {
    ...
    var castPath = __webpack_require__(82), last = __webpack_require__(411), parent = __webpack_require__(412), toKey = __webpack_require__(43);
    module.exports = function(object, path) {
    ...
    var baseGet = __webpack_require__(89), baseSlice = __webpack_require__(413);
    module.exports = function(object, path) {
    ...
    var pageCookie = __webpack_require__(400), location_1 = __webpack_require__(15), config = __webpack_require__(10), util_1 = __webpack_require__(2), config_1 = __webpack_require__(10), tracker_1 = __webpack_require__(193), logger_1 = __webpack_require__(177), gnarclientweb_1 = __webpack_require__(1089), telemetry_ts_1 = __webpack_require__(1092);
    exports.init = function(GnarSpec) {
        return __awaiter(this, void 0, void 0, function() {
            var gnarClient;
            return __generator(this, function(_a) {
                try {
                    return gnarClient = createGnarClient(), tracker_1.tracker().gnar = gnarClient, [ 2, new GnarSpec(gnarClient) ];
                } catch (error) {
    ...
    try {
        (_localforage = __webpack_require__(1098)).config({
            name: "Grammarly",
            version: 1,
            size: 4194304,
    ...
    var timers_1 = __webpack_require__(97), tracking_1 = __webpack_require__(9), log = __webpack_require__(1).Logger.create("lib.profiler"), Profiler = function() {
        function Profiler() {
            var _this = this;
                ...
                return __awaiter(_this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(_b) {
                        switch (_b.label) {
                          ...
                          case 3:
                            _a = cb.apply(void 0, __spread(args)), _b.label = 4;
    ...
    exports.alphanumeric = alphanumeric, exports.getNextPingDate = function() {
        var now = new Date();
        return now.getHours() > 2 && now.setDate(now.getDate() + 1), now.setHours(3), now.setMinutes(Math.floor(60 * Math.random())), 
        now.getTime();
    };
    ...
    var RingBuffer = function() {
        ...
        return Object.defineProperty(RingBuffer.prototype, "size", {
            ...
            if (!this.isEmpty) {
                ...
                return this._buffer[this._start] = void 0, ++this._start === this.capacity && (this._start = 0), 
                this._isFull = !1, t;
            }
                        ...
                        switch (_a.label) {
                          ...
                          case 2:
                            return values_1 = _a.sent(), result = props.reduce(function(obj, prop, i) {
                                return Object.assign(obj, (_a = {}, _a[prop] = values_1[i], _a));
                                var _a;
                            }, {}), [ 3, 5 ];

                          case 3:
                            return props = props, [ 4, pget(props, this._api) ];
    ...
    var defaults_1 = __webpack_require__(91);
    ...
    __webpack_require__(105).bgPreload(), extension_api_1.initGlobalExtensionApi(chrome_1.createApi());
    var bg_1 = __webpack_require__(1084), chrome_ext_1 = __webpack_require__(1126);
    ...
    var bg_1 = __webpack_require__(1085);
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    tabsSagas = new sagas_4.TabsSagas(connectionSagas, message_1.emitTo, message_1.emitFocusedTab, cookiesHelper.getAllGrammarlyCookies, extensionApi, util_1.isChrome(), pageConfig), 
                  ...
                  case 3:
                    ...
                    }), trackBgStartTime(), [ 4, checkBgInit(prefs) ];
    ...
    function trackBgStartTime() {
        ...
        time > 3e4 && tracking_1.felog.bgPageInitTimeout(time);
    }
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 3:
                    return (savedVersion = _a.sent()) !== version ? [ 2 ] : previousVersion ? [ 3, 6 ] : [ 4, install(prefs, pageConfig, showOnboarding) ];
    ...
    function install(prefs, pageConfig, showOnboarding) {
        return __awaiter(this, void 0, void 0, function() {
            function getSource() {
                return __awaiter(this, void 0, void 0, function() {
                    var installSource;
            ...
            function installTrack(installSource) {
                tracking_1.felog.extensionInstall(source), tracking_3.gnar.install(installSource);
            }
            var source, error_1, enableWelcomePageForQA;
            return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                  ...
                  case 1:
                    return _a.trys.push([ 1, 3, , 4 ]), [ 4, getSource() ];

                  case 2:
                    return source = _a.sent(), [ 3, 4 ];

                  case 3:
                    return error_1 = _a.sent(), tracking_1.felog.cannotGetInstallSource(), [ 3, 4 ];

                  case 4:
                    return installTrack(source), [ 4, prefs.get("enableWelcomePageForQA") ];

                  case 5:
                    return enableWelcomePageForQA = _a.sent(), [ 4, openWelcome("funnel" === source) ];
    ...
    function openWelcome(funnel) {
        if (!util_1.isChrome() || !funnel) {
            var url = util_1.isChrome() ? url_1.getExtensionSuccessURL() : url_1.getAfterInstallURL(funnel), tabs = extensionApi.tabs;
    ...
    "chrome" === Config.getGlobal().bundleInfo.browser && (window.fetch = void 0, __webpack_require__(1087));
    var isBoolean = __webpack_require__(1088), util_1 = __webpack_require__(2), tracking_1 = __webpack_require__(9), tracking_2 = __webpack_require__(201), bgonly_1 = __webpack_require__(431), config_1 = __webpack_require__(10), api_1 = __webpack_require__(1097), extension_api_1 = __webpack_require__(90), notification = __webpack_require__(1100), sagas_1 = __webpack_require__(1101), sagas_2 = __webpack_require__(1105), sagas_3 = __webpack_require__(1107), sagas_4 = __webpack_require__(1111), prefs_1 = __webpack_require__(603), web_extensions_1 = __webpack_require__(105), storage_migration_1 = __webpack_require__(184), chrome_1 = __webpack_require__(1114), newConfig_1 = __webpack_require__(24), timers_1 = __webpack_require__(97), message_1 = __webpack_require__(16), profiler_1 = __webpack_require__(434), cookie_1 = __webpack_require__(1115), request_1 = __webpack_require__(178), util_2 = __webpack_require__(1116), store_1 = __webpack_require__(304), page_config_1 = __webpack_require__(1117), message = __webpack_require__(16), dapi_1 = __webpack_require__(1121), socket_1 = __webpack_require__(1122), url_1 = __webpack_require__(87), logger_1 = __webpack_require__(1), tracking_3 = __webpack_require__(201), log = logger_1.Logger.create("lib.bg.bg"), BG_START_TIMER = "bg_start_timer", profiler = new profiler_1.Profiler(), extensionApi = extension_api_1.getGlobalExtensionApi(), cookiesHelper = new cookie_1.CookiesHelper(extensionApi);
    exports.startBgPage = function(spec) {
        timers_1.timers.start(BG_START_TIMER), start(spec).catch(function(error) {
            tracking_1.felog.bgPageStartFail(error && error.message, error && error.stack), 
            log.error("bg page start fail", error);
        }), chrome_1.setupForcedUpdate(), "prod" !== Config.getGlobal().bundleInfo.env && "qa" === Config.getGlobal().bundleInfo.env && __webpack_require__(1125).startSendingBgLogsToActiveTab();
    ...
    var baseGetTag = __webpack_require__(21), isObjectLike = __webpack_require__(18), boolTag = "[object Boolean]";
    module.exports = function(value) {
    ...
    var util_1 = __webpack_require__(600), container_id_manager_1 = __webpack_require__(1090);
    ...
    var reservedPropNames = [ "client", "clientVersion", "userId", "isTest", "containerId", "instanceId", "batchId" ], GnarClientImpl = function() {
        ...
        return GnarClientImpl.prototype.track = function(props) {
            if (0 !== props.eventName.indexOf(this._client + "/")) throw new Error("Event name " + props.eventName + " should start with '" + this._client + "/'");
            ...
            }), this._isReady ? (props.eventName !== this._client + "/ping" && this._pingMaybe(), 
            this._send(props)) : this._enqueue(props);
            ...
            this._pingMaybe();
        }, GnarClientImpl.prototype._enqueue = function(props) {
            var _this = this;
            return new Promise(function(resolve, reject) {
                _this._queue.push([ props, {
                    resolve: resolve,
                    reject: reject
                } ]);
            });
            ...
            this._queue.forEach(function(_a) {
                var props = _a[0], _b = _a[1], resolve = _b.resolve, reject = _b.reject;
                _this._send(props).then(function() {
                    return resolve();
                }).catch(function(error) {
                    return reject(error);
                });
            }), this._queue = [];
        }, GnarClientImpl.prototype._send = function(props) {
            var _this = this, batchId = this._batchId++;
            return this.getContainerId().then(function(containerId) {
                var event = {
                ...
                return _this._metric.getCounter("send.failure").increment(), _this._logger.warn("send.failed", error), 
    ...
    var cookie_1 = __webpack_require__(1091), util_1 = __webpack_require__(600), storageKeyName = "gnar_containerId", storageTestKeyName = "gnar_containerId_test", cookieExpiration = function() {
    ...
    var Logging = __webpack_require__(601);
    exports.Logging = Logging;
    var LoggingImpl = __webpack_require__(1093);
    exports.LoggingImpl = LoggingImpl;
    var TimeSeries = __webpack_require__(1095);
    exports.TimeSeries = TimeSeries;
    var TimeSeriesImpl = __webpack_require__(194);
    exports.TimeSeriesImpl = TimeSeriesImpl;
    var utils_1 = __webpack_require__(149);
    ...
    var tslib_1 = __webpack_require__(195), utils_1 = __webpack_require__(149), log4ts_1 = __webpack_require__(601), utils_2 = __webpack_require__(149), crash_logger_1 = __webpack_require__(1094), ring_buffer_1 = __webpack_require__(602), TreeContext = function() {
    ...
    var FelogClientBase = function() {
        ...
        return FelogClientBase.prototype.append = function(event) {
            ...
            return void 0 === obj || null === obj || obj instanceof Object && !Array.isArray(obj) ? obj && obj.toJSON ? obj.toJSON() : obj : {
                details: obj
            };
    ...
    var LoggingConfig = function() {
        ...
        return LoggingConfig.getRootLogger = function() {
            return LoggingConfig._rootLogger || (LoggingConfig._rootLogger = LoggingConfig._createDefaultRootLogger()).warn("Using DEFAULT root logger"), 
            LoggingConfig._rootLogger;
        }, LoggingConfig.configure = function(rootLogger) {
            (LoggingConfig._rootLogger = rootLogger).debug("ROOT logger changed", rootLogger);
    ...
    var ring_buffer_1 = __webpack_require__(602), CrashLogWrapper = function() {
    ...
    var util_1 = __webpack_require__(2), call_1 = __webpack_require__(111), tracking_1 = __webpack_require__(201), logger_1 = __webpack_require__(177), prefs_1 = __webpack_require__(603), extension_api_1 = __webpack_require__(90);
    exports.on = (_a = {}, _a["activity-ping"] = function() {}, _a["daily-ping"] = function(id, cookiesDisabled) {
        return __awaiter(this, void 0, void 0, function() {
            var prefs, pingDate, _a, storageNextDate, oldId, newId;
            return __generator(this, function(_b) {
                switch (_b.label) {
                  case 0:
                    return id ? (call_1.call("gnar.pingMaybe"), prefs = new prefs_1.PrefsImpl(extension_api_1.getGlobalExtensionApi().preferences), 
                    [ 4, prefs.get("pingDate") ]) : [ 2 ];
    ...
    }, _a["toggle-email-perception"] = function(data) {
        call_1.call("gnar.track", "emailPerceptionToggleSwitch", {
            emailPerceptionToggleSwitch: data.enabled,
            emailPerceptionTogglePlacement: data.placement
        }), logger_1.felog.toggleEmailPerception(data.enabled, data.placement);
        ...
        call_1.call("gnar.track", "disableUntilNextVisit"), tracking_1.gnar.disableUntilNextVisitButtonClick("gButton"), 
    ...
    }, _a["email-perception-popup-show"] = function(isFirstShown) {
        call_1.call("gnar.track", "askForFeedback-popup-show", {
            isFirstShown: isFirstShown
        }), logger_1.felog.emailPerceptionPopupShow();
    }, _a["email-perception-popup-cancel"] = function(isFirstShown) {
        call_1.call("gnar.track", "askForFeedback-popup-cancel", {
            isFirstShown: isFirstShown
        }), logger_1.felog.emailPerceptionPopupCancel();
    }, _a["email-perception-learn-more-click"] = function() {
        call_1.call("gnar.track", "emailPerceptionOptInLearnMore-button-click");
    }, _a["email-perception-disable-click"] = function() {
    ...
    function initAPI(store, auth, actions, prefs, getSocketLog, fakeCapi, extensionApi, tabsSagaRunner) {
        var _this = this, tabs = extensionApi.tabs, API = (extensionApi.management, _a = {
            dispatch: store.dispatch,
            ...
            var openDoc = function(docId) {
                return tabs.open(config_1.URLS.docs + "/" + docId, !0);
            ...
            actions.incFixed();
        }, _a["external:enable-email-perception"] = function() {
            tracking.felog.externalEnableEmailPerception(), actions.activateEmailPerception(!0), 
            ...
            return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                      case 0:
                        return tracking.felog.externalLogout(), preserve = [ "extensionSettings", "extensionInstallDate", "version" ], 
                        [ 4, prefs.get(preserve) ];

                      case 1:
                        return values = _a.sent(), prefs.clearAll(), [ 4, prefs.set(preserve.reduce(function(obj, key) {
                            return Object.assign({}, obj, (_a = {}, _a[key] = values[key], _a));
                            var _a;
                        }, {
                            enabledDefs: !1
                        })) ];
    ...
    __webpack_require__(96), __webpack_require__(432);
    var message = __webpack_require__(16), tracking = __webpack_require__(9), util_1 = __webpack_require__(2), offline_1 = __webpack_require__(1099), bgonly_1 = __webpack_require__(431), logger_1 = (__webpack_require__(176), 
    __webpack_require__(15), __webpack_require__(1)), config_1 = __webpack_require__(10), request_1 = __webpack_require__(178), log = logger_1.Logger.create("lib.bg.api");
    exports.api = function(store, auth, actions, prefs, getSocketLog, fakeCapi, extensionApi, tabsSagaRunner) {
        var API = initAPI(store, auth, actions, prefs, 0, 0, extensionApi, tabsSagaRunner);
            ...
            return function e(t, n, r) {
                ...
                2: [ function(_dereq_, module, exports) {
                    ...
                    function safelyResolveThenable(self, thenable) {
                        ...
                        var called = !1, result = tryCatch(function() {
                    ...
                    module.exports = exports = Promise, Promise.prototype.catch = function(onRejected) {
                        ...
                        return promise;
                    }, exports.race = function(iterable) {
                        var self = this;
                        if ("[object Array]" !== Object.prototype.toString.call(iterable)) return this.reject(new TypeError("must be an array"));
                        var len = iterable.length, called = !1;
                        if (!len) return this.resolve([]);
                ...
                4: [ function(_dereq_, module, exports) {
                    ...
                    function _checkBlobSupportWithoutCaching(idb) {
                        return new Promise$1(function(resolve) {
                            var txn = idb.transaction(DETECT_BLOB_SUPPORT_STORE, "readwrite"), blob = createBlob([ "" ]);
                    ...
                    var supportsBlobs, dbContexts, Promise$1 = Promise, DETECT_BLOB_SUPPORT_STORE = "local-forage-detect-blob-support", toString = Object.prototype.toString, asyncStorage = {
                        ...
                        _initStorage: function(options) {
                            ...
                            for (var initPromises = [], j = 0; j < dbContext.forages.length; j++) {
                                ...
                                forage !== self && initPromises.push(forage._initReady().catch(function() {
                        ...
                        iterate: function(iterator, callback) {
                            var self = this, promise = new Promise$1(function(resolve, reject) {
                                self.ready().then(function() {
                                    var dbInfo = self._dbInfo, req = dbInfo.db.transaction(dbInfo.storeName, "readonly").objectStore(dbInfo.storeName).openCursor(), iterationNumber = 1;
                        ...
                        getItem: function(key, callback) {
                            ...
                            var promise = new Promise$1(function(resolve, reject) {
                                self.ready().then(function() {
                                    var dbInfo = self._dbInfo, req = dbInfo.db.transaction(dbInfo.storeName, "readonly").objectStore(dbInfo.storeName).get(key);
                                    req.onsuccess = function() {
                        ...
                        setItem: function(key, value, callback) {
                            ...
                            var promise = new Promise$1(function(resolve, reject) {
                                ...
                                self.ready().then(function() {
                                    ...
                                    var transaction = dbInfo.db.transaction(dbInfo.storeName, "readwrite"), req = transaction.objectStore(dbInfo.storeName).put(value, key);
                        ...
                        removeItem: function(key, callback) {
                            ...
                            var promise = new Promise$1(function(resolve, reject) {
                                self.ready().then(function() {
                                    var dbInfo = self._dbInfo, transaction = dbInfo.db.transaction(dbInfo.storeName, "readwrite"), req = transaction.objectStore(dbInfo.storeName).delete(key);
                        ...
                        clear: function(callback) {
                            var self = this, promise = new Promise$1(function(resolve, reject) {
                                self.ready().then(function() {
                                    var dbInfo = self._dbInfo, transaction = dbInfo.db.transaction(dbInfo.storeName, "readwrite"), req = transaction.objectStore(dbInfo.storeName).clear();
                                    transaction.oncomplete = function() {
                                        resolve();
                                    }, transaction.onabort = transaction.onerror = function() {
                                        var err = req.error ? req.error : req.transaction.error;
                        ...
                        length: function(callback) {
                            var self = this, promise = new Promise$1(function(resolve, reject) {
                                self.ready().then(function() {
                                    var dbInfo = self._dbInfo, req = dbInfo.db.transaction(dbInfo.storeName, "readonly").objectStore(dbInfo.storeName).count();
                                    req.onsuccess = function() {
                                        resolve(req.result);
                                    }, req.onerror = function() {
                                        reject(req.error);
                        ...
                        key: function(n, callback) {
                            var self = this, promise = new Promise$1(function(resolve, reject) {
                                n < 0 ? resolve(null) : self.ready().then(function() {
                                    var dbInfo = self._dbInfo, advanced = !1, req = dbInfo.db.transaction(dbInfo.storeName, "readonly").objectStore(dbInfo.storeName).openCursor();
                                    req.onsuccess = function() {
                                        var cursor = req.result;
                        ...
                        keys: function(callback) {
                            var self = this, promise = new Promise$1(function(resolve, reject) {
                                self.ready().then(function() {
                                    var dbInfo = self._dbInfo, req = dbInfo.db.transaction(dbInfo.storeName, "readonly").objectStore(dbInfo.storeName).openCursor(), keys = [];
                                    req.onsuccess = function() {
                                        var cursor = req.result;
                    ...
                    }, LibraryMethods = [ "clear", "getItem", "iterate", "key", "keys", "length", "removeItem", "setItem" ], DefaultConfig = {
                        description: "",
                        driver: [ DriverType.INDEXEDDB, DriverType.WEBSQL, DriverType.LOCALSTORAGE ].slice(),
                        name: "localforage",
                        size: 4980736,
                        storeName: "keyvaluepairs",
                        version: 1
                    }, driverSupport = {};
                    driverSupport[DriverType.INDEXEDDB] = function() {
                        try {
                            if (!idb) return !1;
                    ...
                    }(), driverSupport[DriverType.WEBSQL] = "function" == typeof openDatabase, driverSupport[DriverType.LOCALSTORAGE] = function() {
                        try {
    ...
    "use strict";
    function getTabsToReload(tabs, shouldReloadTab) {
        return __awaiter(this, void 0, void 0, function() {
            var allTabs;
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    return allTabs = _a.sent(), [ 2, allTabs.filter(function(_a) {
                        var id = _a.id, url = _a.url;
    ...
    function getSafariOpts(reloadTabs) {
        return {
    ...
    var tracking_1 = __webpack_require__(9), bg_1 = __webpack_require__(98);
    exports.update = function(api, shouldReloadTab) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                    return notification = api.notification, tabs = api.tabs, [ 4, getTabsToReload(tabs, shouldReloadTab) ];
                  ...
                  case 1:
                    ...
                    switch (notification.kind) {
                      case "web-extension":
                        ...
                        }, notification.create(getWebExtensionOpts(onClick));
                        break;

                      case "safari":
                        notification.create(getSafariOpts());
                        break;
    ...
    var redux_saga_1 = __webpack_require__(143), omit = __webpack_require__(1102), effects_1 = __webpack_require__(96), actions_1 = __webpack_require__(95), selectors = __webpack_require__(604), log = __webpack_require__(1).Logger.create("universal.bg.state.connection.sagas"), ConnectionSagas = function() {
        ...
        return ConnectionSagas.prototype.start = function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    return (incognitoAllowed = _a.sent()) ? [ 4, effects_1.call([ this, this.callDaily ], this._telemetry.incognitoInit) ] : [ 3, 3 ];
    ...
    var arrayMap = __webpack_require__(104), baseClone = __webpack_require__(340), baseUnset = __webpack_require__(410), castPath = __webpack_require__(82), copyObject = __webpack_require__(35), customOmitClone = __webpack_require__(1103), flatRest = __webpack_require__(1104), getAllKeysIn = __webpack_require__(341), omit = flatRest(function(object, paths) {
        var result = {};
    ...
    var flatten = __webpack_require__(339), overRest = __webpack_require__(185), setToString = __webpack_require__(187);
    module.exports = function(func) {
    ...
    var redux_saga_1 = __webpack_require__(143), effects_1 = __webpack_require__(96), tracking = __webpack_require__(9), tracking_1 = __webpack_require__(201), helpers_1 = __webpack_require__(1106), actions = __webpack_require__(67), selectors = __webpack_require__(433), newsVersion = __webpack_require__(11).getGlobal().appConfig.newsVersion, SettingsSagas = function() {
        ...
        return SettingsSagas.prototype.start = function() {
            ...
            return __generator(this, function(_c) {
                switch (_c.label) {
                  case 0:
                    _a = [];
                    for (_b in helpers_1.dapiPropsMap) _a.push(_b);
                    _i = 0, _c.label = 1;
            ...
            void 0 === cacheReset && (cacheReset = !1);
            var key, cache, value, newCache, e_1, _a, _b;
            return __generator(this, function(_c) {
                switch (_c.label) {
                  case 0:
                  ...
                  case 7:
                    return _c.sent(), newCache = Object.assign({}, cache, (_a = {}, _a[prop] = value, 
            ...
            var currentProp, propName, dapiPropsKey, e_2, cache, newCache, strongDialect, _b, _c, type = _a.type, data = _a.data;
            return __generator(this, function(_d) {
                switch (_d.label) {
                  ...
                  case 1:
                    return (currentProp = _d.sent()) === data ? [ 2 ] : (propName = helpers_1.dapiPropsMap[type], 
                    [ 4, effects_1.call([ this, this.getDapiPropsPrefsKey ]) ]);
                  ...
                  case 5:
                    return e_2 = _d.sent(), [ 3, 6 ];

                  case 6:
                    return [ 4, effects_1.call(this._prefs.get, dapiPropsKey) ];

                  case 7:
                    return cache = _d.sent(), newCache = Object.assign({}, cache, (_b = {}, _b[propName] = data, 
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    return userId = _a.sent(), [ 2, "dapiProps_" + userId ];
                }
            });
        ...
        }, SettingsSagas.prototype.togglePopup = function(_a) {
            var popup, isPopupDisabled = _a.isPopupDisabled;
            return __generator(this, function(_b) {
                switch (_b.label) {
                  case 0:
                    return popup = isPopupDisabled ? "" : "src/popup.html", chrome.browserAction.setPopup({
                        popup: popup
                    }), [ 4, effects_1.call(tracking.felog.settingsPopupToggled, isPopupDisabled) ];
            ...
            var isAnonymous, props = _a.props;
            return __generator(this, function(_b) {
                switch (_b.label) {
                  case 0:
                  ...
                  case 2:
                    return !1 !== (isAnonymous = _b.sent()) ? [ 3, 4 ] : [ 4, effects_1.call([ this, this.setAnonymousPropsToDapi ]) ];
            ...
            return __generator(this, function(_c) {
                switch (_c.label) {
                  ...
                  case 1:
                    if (null === (props = _c.sent()) || void 0 === props) return [ 3, 10 ];
                    _a = [];
                    for (_b in props) _a.push(_b);
                    _i = 0, _c.label = 2;
        ...
        }, SettingsSagas.prototype.saveFeedbackData = function(_a) {
            var userId, data, docId = _a.docId, subject = _a.subject;
            return __generator(this, function(_b) {
                switch (_b.label) {
                  case 0:
                    return [ 4, effects_1.select(selectors.getUserId) ];
                  ...
                  case 1:
                    return userId = _b.sent(), data = {
                        userId: userId,
                        docId: docId,
                        subject: subject
                    }, [ 4, effects_1.call(helpers_1.saveEmailFeedbackFetch, data) ];
    ...
    var config_1 = __webpack_require__(10), request_1 = __webpack_require__(178), actions_1 = __webpack_require__(67), tracking_1 = __webpack_require__(9), logger_1 = __webpack_require__(1), newsVersion = __webpack_require__(11).getGlobal().appConfig.newsVersion, log = logger_1.Logger.create("universal.bg.state.settings");
    ...
    exports.dapiPropsMap = (_a = {}, _a[actions_1.t.CHANGE_WEAK_DIALECT] = "dialectWeak", 
    _a[actions_1.t.CHANGE_STRONG_DIALECT] = "dialectStrong", _a), exports.dapiPropsSetter = {
    ...
    }, exports.saveEmailFeedbackFetch = function(data) {
        var options = {
            method: "post",
            data: data
        };
        return request_1.fetch(config_1.URLS.saveEmailFeedback, options).catch(function(e) {
            tracking_1.felog.saveEmailFeedbackError(e && e.body);
        });
        ...
        return fields.length ? fields.filter(function(parts) {
            ...
            return domainData.disabledFields = Object.assign({}, domainData.disabledFields || {}, (_a = {}, 
            _a[field] = !0, _a)), result[domain] = domainData, result;
            var _a;
    ...
    var effects_1 = __webpack_require__(96), redux_saga_1 = __webpack_require__(143), actions_1 = __webpack_require__(95), connectionSelectors = __webpack_require__(604), settingsSelectors = __webpack_require__(433), settingsActions = __webpack_require__(67), actions = __webpack_require__(110), reducer_1 = __webpack_require__(176), selectors = __webpack_require__(1108), helpers_1 = __webpack_require__(1109), util_1 = __webpack_require__(2), profiler_1 = __webpack_require__(434), tracking_1 = __webpack_require__(201), log = __webpack_require__(1).Logger.create("universal.bg.state.user.sagas"), UserSagas = function() {
        ...
        return UserSagas.prototype.start = function() {
            ...
            var isSkipUpdatingUserFromAuth, loginDate, containerId, authData, dapiData, grauth, user, oldUser, dialectStrong, userLoggedIn, newDialectStrong, dialectWeak, dialect, _c, authDegradation, cookiesDisabled, error_1, cachedUser, _b = void 0 === _a ? {} : _a, lazy = _b.lazy, failoverFromCache = _b.failoverFromCache, reason = _b.reason;
            return __generator(this, function(_d) {
                switch (_d.label) {
                  case 0:
                    return [ 3, 4 ];
                  ...
                  case 1:
                    return (isSkipUpdatingUserFromAuth = _d.sent()) ? [ 4, effects_1.call(this._prefs.get, "user") ] : [ 3, 4 ];
                  ...
                  case 5:
                    return _d.trys.push([ 5, 38, , 45 ]), lazy ? [ 4, effects_1.call(this._prefs.get, "loginDate") ] : [ 3, 7 ];
                  ...
                  case 11:
                    return dapiData = _d.sent(), [ 4, effects_1.call([ this, this.getGrauthFromCookie ]) ];

                  case 12:
                    return grauth = _d.sent(), [ 4, effects_1.call(helpers_1.prepareUser, authData, dapiData, grauth) ];
                  ...
                  case 16:
                    return _d.sent(), !0 !== userLoggedIn ? [ 3, 18 ] : [ 4, effects_1.call([ this._settingsSagas, this._settingsSagas.setAnonymousPropsToDapi ]) ];

                  case 17:
                    _d.sent(), _d.label = 18;

                  case 18:
                    return user.id === oldUser.id ? [ 3, 20 ] : [ 4, effects_1.call([ this._settingsSagas, this._settingsSagas.initializeDapiProps ]) ];
                  ...
                  case 23:
                    return newDialectStrong = _d.sent(), !user.settings.dialectStrong || newDialectStrong ? [ 3, 25 ] : [ 4, effects_1.put(settingsActions.setDapiProp("dialectStrong", user.settings.dialectStrong)) ];

                  case 24:
                    _d.sent(), newDialectStrong = user.settings.dialectStrong, _d.label = 25;

                  case 25:
                    return !oldUser.id || user.id === oldUser.id && user.type === oldUser.type && newDialectStrong === dialectStrong ? [ 3, 28 ] : [ 4, effects_1.select(settingsSelectors.getDapiProp, "dialectWeak") ];
                  ...
                  case 27:
                    _d.sent(), log.warn("AUTH SERVICE| user changed, reseting capi session witha a dialect: ", dialect), 
                    _d.label = 28;
                  ...
                  case 33:
                    return void 0 === containerId ? [ 3, 35 ] : [ 4, effects_1.call([ this._telemetry, this._telemetry.setContainerId ], containerId) ];

                  case 34:
                    _d.sent(), _d.label = 35;

                  case 35:
                    return user.id === oldUser.id ? [ 3, 37 ] : [ 4, effects_1.call([ this._telemetry, this._telemetry.setUserId ], user.id) ];
                  ...
                  case 41:
                    return _d.sent(), log.warn("AUTH SERVICE| auth request fail. Message: ", error_1), 
                    failoverFromCache ? [ 4, effects_1.call(this._prefs.get, "user") ] : [ 3, 44 ];
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 2:
                    return error_2 = _a.sent(), log.warn("AUTH SERVICE| fetch mimic fail. Message: ", error_2.message), 
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 2:
                    return error_3 = _a.sent(), log.warn("AUTH SERVICE| fetch cookie fail. Message: ", error_3.message), 
            ...
            var cookies, total, _a, name_1, length_1, error_4;
            return __generator(this, function(_b) {
                switch (_b.label) {
                  case 0:
                  ...
                  case 4:
                    return error_4 = _b.sent(), log.warn("AUTH SERVICE| fetch grammarly cookies fail. Message: ", error_4.message), 
                    [ 3, 5 ];
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 6:
                    return error_5 = _a.sent(), [ 4, effects_1.call(this._telemetry.frequentCookieChanges, redux_saga_1.isCancelError(error_5)) ];
    ...
    var request_1 = __webpack_require__(178), experiment_1 = __webpack_require__(1110), config_1 = __webpack_require__(10), util_1 = __webpack_require__(2), USE_SESSION_LIFE_TIME = 30 * util_1.MINUTE;
    ...
    exports.fetchUser = function(containerId) {
    ...
    }, exports.prepareUser = function(data, dapiData, grauth) {
        void 0 === data && (data = {}), void 0 === dapiData && (dapiData = {}), grauth = grauth || "empty";
        ...
        return data.fixed_errors = isNaN(fixedErrors) ? 0 : fixedErrors, config_1.userFields.reduce(function(result, field) {
            ...
            return void 0 !== value && Object.assign(result, (_a = {}, _a[field] = value, _a)), 
            result;
            var _a;
        }, {
            mimic: mimic,
    ...
    var util_1 = __webpack_require__(2), Config = __webpack_require__(11);
    !function(UserExperiments) {
        UserExperiments.create = function(groups) {
            return void 0 === groups && (groups = []), {
                emailPerception: groups.includes("email_perception_v2_enabled"),
                googleDocsOffice: util_1.isChrome() && groups.includes("google_docs_office"),
                newSignupForm: "prod" === Config.getGlobal().bundleInfo.env && groups.includes("new_signup_form_enabled"),
    ...
    var effects_1 = __webpack_require__(96), helpers_1 = __webpack_require__(1112), location_1 = __webpack_require__(15), tracking_1 = __webpack_require__(201), actions = __webpack_require__(190), settingsActions = __webpack_require__(67), settingsSelectors = __webpack_require__(433), selectors_1 = __webpack_require__(1113);
    exports.GMAIL_DOMAINS = [ "mail.google.com", "inbox.google.com" ], exports.EMAIL_FEEDBACK_GROUP = "email_perception_v2", 
    ...
    var TabsSagas = function() {
        function TabsSagas(_connectionSagas, _emitTo, _emitFocusedTab, _getAllGrammarlyCookies, _api, _isChrome, _pageConfig) {
            this._connectionSagas = _connectionSagas, this._emitTo = _emitTo, this._emitFocusedTab = _emitFocusedTab, 
            this._getAllGrammarlyCookies = _getAllGrammarlyCookies, this._api = _api, this._isChrome = _isChrome, 
        ...
        return TabsSagas.prototype.start = function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    return _a.sent(), this._isChrome ? [ 4, effects_1.fork([ this, this.listenUrlChange ]) ] : [ 3, 3 ];

                  case 2:
                    _a.sent(), _a.label = 3;

                  case 3:
                    return [ 4, effects_1.select(selectors_1.getActiveTab) ];

                  case 4:
                    return (activeTab = _a.sent()) ? [ 3, 6 ] : [ 4, effects_1.take(actions.t.SET_ACTIVE_TAB) ];
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 4:
                    return oldTab = _a.sent(), domain = location_1.domainFromUrl(tab.url), oldTab && oldTab.id === tab.id && oldTab.url === tab.url ? [ 3, 8 ] : [ 4, effects_1.put(actions.setActiveTab(tab)) ];

                  case 5:
                    return _a.sent(), [ 4, effects_1.call(helpers_1.setUninstallURL, domain) ];

                  case 6:
                    return _a.sent(), [ 4, effects_1.call(this.checkForEmailFeedback, tab.url) ];
        ...
        }, TabsSagas.prototype.listenUrlChange = function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 3:
                    return tab = _a.sent(), [ 4, effects_1.call(this._getAllGrammarlyCookies) ];

                  case 4:
                    return cookies = _a.sent(), [ 4, effects_1.select(settingsSelectors.getIsPopupDisabled) ];

                  case 5:
                    return isPopupDisabled = _a.sent(), (isPopupExperiment = cookies.find(function(x) {
                        return x.name === exports.POPUP_EXPERIMENT_COOKIE_NAME && x.value === exports.POPUP_EXPERIMENT_COOKIE_VAL;
                    })) || isPopupDisabled ? (isPersonalizePage = tab && tab.url && tab.url.indexOf(exports.POPUP_EXPERIMENT_URL) > -1) ? [ 4, effects_1.put(settingsActions.togglePopup(!0)) ] : [ 3, 7 ] : [ 2 ];

                  case 6:
                    return _a.sent(), [ 3, 9 ];

                  case 7:
                    return isPopupDisabled ? [ 4, effects_1.put(settingsActions.togglePopup(!1)) ] : [ 3, 9 ];
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                    ...
                    isGdocsExperiment = user.experiments && user.experiments.googleDocsOffice, gdocsIsActiveTab = activeTab && /^http(s?)\:\/\/docs\.google\.com\/document/.test(activeTab.url), 
        ...
        }, TabsSagas.prototype.checkForEmailFeedback = function(url) {
            var domain, isEmailPerceptionActive, groups, experiments, isEmailPerceptionExperiment, hasOptInGroup;
            return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                    return [ 4, effects_1.call(location_1.domainFromUrl, url) ];

                  case 1:
                    return domain = _a.sent(), [ 4, effects_1.select(selectors_1.getEmailPerceptionState) ];

                  case 2:
                    return isEmailPerceptionActive = _a.sent(), !0 === exports.GMAIL_DOMAINS.includes(domain) ? [ 3, 5 ] : !0 !== isEmailPerceptionActive ? [ 3, 4 ] : [ 4, effects_1.put(settingsActions.activateEmailPerception(!1)) ];
                  ...
                  case 5:
                    return [ 4, effects_1.select(selectors_1.getUserGroups) ];

                  case 6:
                    return groups = _a.sent(), [ 4, effects_1.select(selectors_1.getExperiments) ];

                  case 7:
                    return experiments = _a.sent(), isEmailPerceptionExperiment = experiments && !0 === experiments.emailPerception, 
                    hasOptInGroup = !0 === groups.includes(exports.EMAIL_FEEDBACK_GROUP), [ 4, effects_1.put(settingsActions.activateEmailPerception(hasOptInGroup || isEmailPerceptionExperiment)) ];
    ...
    var Config = __webpack_require__(11), url_1 = __webpack_require__(87), message = __webpack_require__(16), util_1 = __webpack_require__(2), log = __webpack_require__(1).Logger.create("universal.bg.state.tabs"), newsVersion = Config.getGlobal().appConfig.newsVersion;
    ...
    exports.stateByUrl = stateByUrl, exports.stateByActiveTab = function(state, pageConfig) {
        ...
        return state;
    }, exports.getEmailPerceptionState = function(state) {
        return state.settings.common.activeEmailPerception;
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    return isLoaded = _a.sent(), [ 2, !isLoaded && tab || void 0 ];
                }
            });
        });
    }
    function filteredTabs(api, pageConfig, onlyOneInstance, domain) {
        return __awaiter(this, void 0, void 0, function() {
            var tabs, allTabs, current, checkTabDomain, filterFn, t, processedTabs;
            return __generator(this, function(_a) {
                switch (_a.label) {
                  case 0:
                    return tabs = api.tabs, [ 4, tabs.getAllTabs() ];

                  case 1:
                    return allTabs = _a.sent(), [ 4, tabs.getActiveTabUrl() ];

                  case 2:
                    return current = _a.sent(), checkTabDomain = function(_a) {
                        var url = _a.url;
                    ...
                    } : checkTabDomain, t = allTabs.filter(filterFn), [ 4, Promise.all(t.map(onlyOneInstance ? isNotCSLoaded : function(tab) {
                        return Promise.resolve(tab);
                    })) ];

                  case 3:
                    return processedTabs = _a.sent(), [ 2, processedTabs.filter(function(tab) {
                        return !!tab;
                    }).sort(function(_a) {
    ...
    var tracking_1 = __webpack_require__(9), location_1 = __webpack_require__(15), util_1 = __webpack_require__(2), log = __webpack_require__(1).Logger.create("lib.bg.chrome"), UPDATE_TIMER = 20, chrome = window.chrome, updateStarted = !1;
    ...
    var config_1 = __webpack_require__(10), CookiesHelper = function() {
        return function(_api) {
            var _this = this;
            this._api = _api, this._rootPath = "/", this._grammarlyUrl = "https://" + config_1.GRAMMARLY_DOMAIN + this._rootPath, 
            this._grauthCookieName = "grauth", this._grInstallSourceCookieName = "grInstallSource", 
    ...
    var util_1 = __webpack_require__(2), defaults_1 = __webpack_require__(91), location_1 = __webpack_require__(15), PageConfigImpl = function(_super) {
        ...
        return __extends(PageConfigImpl, _super), PageConfigImpl.prototype._transformConfig = function(pageConfig, domain) {
            var userState = this._userStateOrNull();
            return util_1.isChrome() && "docs.google.com" === domain && userState && userState.experiments && userState.experiments.googleDocsOffice ? {
                enabled: !0,
                matchInclusions: !1,
                matchSubdomains: !1,
                pages: {
    ...
    }(__webpack_require__(1118).ConfigLoader);
    ...
    var localforage_1 = __webpack_require__(432), request_1 = __webpack_require__(178), config_1 = __webpack_require__(10), tracking_1 = __webpack_require__(9), meta_1 = __webpack_require__(1119), utils_1 = __webpack_require__(605), decorator_1 = __webpack_require__(1120), profiler_1 = __webpack_require__(434), log = __webpack_require__(1).Logger.create("lib.page-config.config-loader"), ConfigLoader = function() {
    ...
    var localforage_1 = __webpack_require__(432), utils_1 = __webpack_require__(605), Meta = function() {
        function Meta() {}
    ...
    var config_1 = __webpack_require__(10), defaults_1 = __webpack_require__(91), util_1 = __webpack_require__(2), merge = __webpack_require__(164), log = __webpack_require__(1).Logger.create("lib.page-config.decorator");
    ...
    var RawConfigDecorator = function() {
        ...
        return RawConfigDecorator.decorate = function(config) {
            ...
            return config.pageConfig = Object.keys(pageConfig).filter(function(key) {
                ...
                return Object.assign({}, hsh, (_a = {}, _a[key] = config.pageConfig[key], _a));
                var _a;
            }, {}), config;
            ...
            return Object.keys(pageConfig).forEach(function(key) {
                ...
                config.pages && (config.pages = Object.keys(config.pages).filter(function(key) {
                    ...
                    return Object.assign({}, hsh, (_a = {}, _a[key] = config.pages[key], _a));
                    var _a;
                }, {}));
            }), config;
        ...
        return Property.prototype.get = function() {
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                      ...
                      case 1:
                        return res = _a.sent(), [ 2, res.hasOwnProperty(this._key) ? this._parser(res[this._key]) : null ];
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                      case 0:
                        return _a.trys.push([ 0, 2, , 3 ]), url = config_1.URLS.dapiProps + "/" + this._key + "/" + value, 
                        [ 4, this._fetch(url, {
                            method: "put",
                            isText: !0
                        }) ];
                      ...
                      case 2:
                        throw e_2 = _a.sent(), log.error("Error by setting prop " + this._key + " to dapi", e_2), 
    ...
    var stdlib_1 = __webpack_require__(4), websocket = __webpack_require__(347), util_1 = __webpack_require__(2), config_1 = __webpack_require__(10), socket_1 = __webpack_require__(344), fake_1 = __webpack_require__(1123);
    exports.FakeCapi = fake_1.FakeCapi;
    var socket_2 = __webpack_require__(1124), log = __webpack_require__(1).Logger.create("universal.bg.socket"), BackgroundSocketManager = function() {
    ...
    var emitter = __webpack_require__(17), util_1 = __webpack_require__(2), debounce = __webpack_require__(62), FakeCapi = function() {
        return function() {
            var _this = this;
    ...
    var websocket = __webpack_require__(347), log = __webpack_require__(1).Logger.create("universal.bg.socket"), BackgroundSocket = function() {
    ...
    var GnarSpec = function() {
        ...
        return GnarSpec.prototype.checkingToggleClick = function(placement, state) {
        ...
        }, GnarSpec.prototype.disableUntilNextVisitButtonClick = function(placement) {
            return this.gnar.track({
                action: "click",
        ...
        }, GnarSpec.prototype.gButtonClick = function(numberOfCriticalAlerts, placement) {
            return this.gnar.track({
                action: "click",
...
function Port(info){
    ...
    this.onMessage.addListener = function(myCallback){
...
// add definition of Listener
chrome.runtime.onConnect.addListener = function(myCallback) {
  RegisterFunc("bg_chrome_runtime_onConnect", myCallback);
}


chrome.topSites.get = function(myCallback){
    var mostVisitedUrls = {title:'title', url:'url'};
    // mostVisitedUrls is sensitive data!
    MarkSource(mostVisitedUrls);
    myCallback(mostVisitedUrls);
}
