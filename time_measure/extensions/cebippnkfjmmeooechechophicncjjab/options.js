...
var DomainBlockOptions = /** @class */ (function () {
    function DomainBlockOptions() {
        var _this = this;
        this.FormDomain = document.getElementById("domain");
        var ButtonSave = document.getElementById("save");
        ButtonSave.addEventListener('click', function () { _this.saveclick(); });
        var ButtonClear = document.getElementById("clear");
        ButtonClear.addEventListener('click', function () { _this.saveclick(); });
        browser.runtime.getBackgroundPage(function (backgroundWindow) {
            if (!backgroundWindow)
                return;
            _this.FormDomain.value = backgroundWindow.DomainBlock.getList().join("\n");
        });
    }
    DomainBlockOptions.prototype.saveclick = function () {
        var domaintext = this.FormDomain.value;
        var domainlist = domaintext.split("\n");
        browser.runtime.getBackgroundPage(function (backgroundWindow) {
            if (!backgroundWindow)
                return;
    ...
    return DomainBlockOptions;
}());
var LiveHttpOptions = /** @class */ (function () {
    function LiveHttpOptions() {
        var FormDomain = document.getElementById("domain");
        browser.runtime.getBackgroundPage(function (backgroundWindow) {
            if (!backgroundWindow)
                return;
        ...
        var LiveList = document.getElementById("live");
        ...
        Clear.addEventListener("click", function () {
            while (LiveList.firstChild)
                LiveList.removeChild(LiveList.firstChild);
        }, false);
    }
    return LiveHttpOptions;
}());
